...
public class PhoneDirectoryWithTreeMap {
     ...
     * in the phone directory, then return the value null
     */
     ...
     * in the phone directory, then the new number replaces the old one. Otherwise, a new
     * name/number pair is added. The name and number should both be non-null.
     * An IllegalArgumentException is thrown if this is not the case
     */
    public void putNumber(String name, String number) {
        if (name == null || number == null) {
            throw new IllegalArgumentException("name and number cannot br null");
        } else {
